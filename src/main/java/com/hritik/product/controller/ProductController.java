...
import com.hritik.product.service.ProductService;
...
public class ProductController {
   ...
   @GetMapping
    ...
    public String saveProduct(@ModelAttribute Product product, @RequestParam("image") MultipartFile image) {
        try {
            productService.saveProduct(product.getName(),null, image,product.getCategory());
 ...
 @GetMapping("/delete/{id}")
    ...
    public String updateProduct(@PathVariable Long id, @ModelAttribute Product product, @RequestParam("image") MultipartFile image) {
        try {
            productService.updateProduct(id, product.getName(), null, image,product.getCategory());
            return "redirect:/products";
        } catch (IOException e) {
            e.printStackTrace();
            return "error";
